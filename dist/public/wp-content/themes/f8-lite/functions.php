...
function werewp_fn_fbvideo($atts, $content = null) {
   ...
   return '<object width="600" height="336" >
   <param name="allowfullscreen" value="true" />
   <param name="allowscriptaccess" value="always" />
   <param name="movie" value="http://www.facebook.com/v/'.$id.'" />
   <embed src="http://www.facebook.com/v/'.$id.'" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="600" height="336">
   </embed>
   </object>';
}
